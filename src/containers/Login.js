...
export default class Login {
  ...
  handleSubmitAdmin = e => {
    ...
    const user = {
      type: "Admin",
      //BUG REPORT - LOGIN - SOLUTION
      //Wrong targeting of the selectors 
      //"employee-email-input" and "employee-password-input"
      //instead of "admin-email-input" and "admin-password-input"
      //------------------------DEBUT---------------------------------------
